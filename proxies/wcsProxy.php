...
if ($outputSrsToUse == "EPSG:4326" and $srsToUse=="EPSG:3857") {
...
//this lets the user pass in the image
//if($_GET['pixelHeight']!=-1 && $_GET['pixelWidth']!=-1 && isset($_GET['extentOverride'])) 
//{
...
echo $layerNameToUse;
echo "<br/>";
echo $lowerLeftXToUse;
echo "<br/>";
echo $lowerLeftYToUse;
echo "<br/>";
echo $upperRightXToUse;
echo "<br/>";
echo $upperRightYToUse;
echo "<br/>";
echo $resolutionB4;
echo "<br/>";
